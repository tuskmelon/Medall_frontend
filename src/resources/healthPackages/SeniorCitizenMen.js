...
export const SeniorCitizenMenPackage = {
  packageName: 'Senior Citizen Men',
  ageRange: '',
  rating: 4.1,
  corpId: '28380',
  description:
    'This integrated package of radiology and pathology tests is specifically curated for senior citizen men, providing a complete analysis of various health parameters. It provides a holistic understanding of specific health conditions faced by men above 60 years of age. Allowing healthcare providers to develop personalized health plans and offer guidance on lifestyle changes and preventive measures.',
  originalPrice: 14900,
  currentPrice: 6699,
  discountAmount: 0,
  type: 'healthPackage',
  ...
  iconWithText: [
    ...
    {
      icon: Toilet,
      text: 'Recommended only for male'
    },
    {
      icon: DeliveryMan,
...
export default SeniorCitizenMenPackage
