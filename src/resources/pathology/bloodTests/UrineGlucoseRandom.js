...
const UrineGlucoseRandom = {
    thumbnail: HoldingTestTube,
    testName: 'Urine Glucose - Random',
    rating: 4.1,
    corpId: "1700",
    alternateTestName: '',
    description: 'Screening test for urine glucose level.',
    ...
    testDetailsPageLink: '/urine-glucose-random',
    popular: false,
...
export default UrineGlucoseRandom
