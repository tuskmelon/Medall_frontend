...
export const ArterialBloodGas = {
    thumbnail: HoldingTestTube,
    testName: 'Arterial Blood Gas - ABG',
    rating: 4.1,
    alternateTestName: '',
    corpId: "1111",
    description: 'It is to evaluate lung function and respiratory, metabolic & kidney disorders.',
    ...
    discountAmount: 0,
    type: 'test',
    relatedToOrgan: 'lungs',
    testDetailsPageLink: '/arterial-blood-gas',
    popular: false,
