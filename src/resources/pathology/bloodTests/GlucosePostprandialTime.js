...
const GlucosePostprandialTime = {
    thumbnail: HoldingTestTube,
    testName: 'Glucose - Postprandial (1.5 Hours)',
    rating: 4.1,
    corpId: "4411",
    alternateTestName: '',
    ...
    chennaiPrice: 75,
    banglorePrice: 75,
    andhraPradeshPrice: 60,
    discountAmount: 0,
    type: 'test',
    relatedToOrgan: 'hormones',
    testDetailsPageLink: '/glucose-postprandial-time',
    popular: false,
...
export default GlucosePostprandialTime
