...
const GlucoseChallenge = {
    thumbnail: HoldingTestTube,
    testName: 'Glucose Challenge Test (GCT)',
    rating: 4.1,
    corpId: "1328",
    alternateTestName: '',
    description: 'Screening test for gestational diabetes.',
    ...
    testDetailsPageLink: '/glucose-challenge',
    popular: false,
...
export default GlucoseChallenge
