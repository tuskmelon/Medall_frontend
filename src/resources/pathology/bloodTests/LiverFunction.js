...
const LiverFunctionTest = {
    ...
    corpId: "1449",
    alternateTestName: '',
    description: 'It helps in the diagnosis of liver disease if a person has signs and symptoms that indicate possible liver dysfunction.',
    ...
    popular: true,
    testDetailsPageLink: '/liver-function-test',
    ...
    propertiesTitle: 'What does Liver Function measures? ',
    properties: [
        // {
