...
const UrineGlucosePostprandial = {
    thumbnail: HoldingTestTube,
    testName: 'Urine Glucose - Postprandial (2 Hrs)',
    rating: 4.1,
    corpId: "1696",
    alternateTestName: '',
    description: 'It helps detect urine glucose level.',
    ...
    testDetailsPageLink: '/urine-glucose-postprandial',
    popular: false,
...
export default UrineGlucosePostprandial
