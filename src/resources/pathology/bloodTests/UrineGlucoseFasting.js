...
const UrineGlucoseFasting = {
    thumbnail: HoldingTestTube,
    testName: 'Urine Glucose - Fasting',
    rating: 4.1,
    corpId: "1701",
    alternateTestName: '',
    ...
    chennaiPrice: 50,
    banglorePrice: 60,
    andhraPradeshPrice: 20,
    discountAmount: 0,
    type: 'test',
    relatedToOrgan: 'hormones',
    testDetailsPageLink: '/urine-glucose-fasting',
    popular: false,
...
export default UrineGlucoseFasting
