...
const FreeT3T4 = {
    ...
    testName: 'Free T3 Free T4 TSH / Free TFT',
    rating: 4.1,
    corpId: "1289",
    alternateTestName: '',
    description: 'It helps diagnose hypothyroidism and hyperthyroidism and monitor thyroid hormone replacement therapy.',
    ...
    testDetailsPageLink: '/free-t3-t4',
    popular: false,
