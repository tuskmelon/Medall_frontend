...
const HBA1CTest = {
    ...
    rating: 4.1,
    corpId: "1343",
    alternateTestName: 'Blood Cell Count',
    description: 'Hba1C test is a blood test that shows what your average blood sugar (glucose) level was over the past three months. Tests are done to diagnose prediabetes or diabetes in patients. Prediabetes indicates the risk of developing diabetes. In cases of known diabetes, Hba1c is used to monitor the condition.',
    parameter: 'Includes : 17 Parameters',
    price: 450,
    chennaiPrice: 510,
    banglorePrice: 700,
    andhraPradeshPrice: 250,
    discountAmount: 0,
    type: 'test',
    relatedToOrgan: 'blood liver immune system',
    testDetailsPageLink: '/hba1c-test',
    popular: true,
    ...
    propertiesTitle: 'What does Hba1c measures? ',
    properties: [
        {
            text: 'Glycosylated Haemoglobin'
        }, {
            text: 'Estimated average Glucose level'
        },
    ],
