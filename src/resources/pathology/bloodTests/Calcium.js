...
const Calcium = {
    ...
    alternateTestName: '',
    corpId: "1164",
    description: 'It helps to to diagnose calcium deficiency & monitor disorders of bone, kidney,parathyroid gland & gastrointestinal tract.',
    ...
    discountAmount: 0,
    type: 'test',
    relatedToOrgan: 'bones',
    testDetailsPageLink: '/calcium',
    popular: false,
