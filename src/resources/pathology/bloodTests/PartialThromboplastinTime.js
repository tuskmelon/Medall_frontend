...
const PartialThromboplastinTime = {
    thumbnail: HoldingTestTube,
    testName: 'Partial Thromboplastin Time (PTT) / APTT',
    rating: 4.1,
    corpId: "1487",
    alternateTestName: '',
    description: "It helps evaluate bleeding disorders & monitor heparin anticoagulant therapy.",
    ...
    testDetailsPageLink: '/partial-thromboplastin-time-test',
    popular: false,
...
export default PartialThromboplastinTime