...
const SputumAFB = {
    ...
    testName: '24 hrs Sputum AFB',
    rating: 4.1,
    alternateTestName: '',
    corpId: "1003",
    description: 'It detects the presence of Acid Fast Bacilli(AFB) & diagnose pulmonary tuberculosis.',
    ...
    testDetailsPageLink: '/sputum-afb',
    type: 'test',
    popular: false,
