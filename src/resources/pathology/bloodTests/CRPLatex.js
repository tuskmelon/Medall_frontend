...
const CRPLatex = {
    ...
    testName: 'C Reactive Protein (CRP) - Latex Agglutination ',
    rating: 4.1,
    alternateTestName: '',
    corpId: "1158",
    description: 'It helps monitor neonatal Infection, arthritis,pelvic inflammatory diseases & post-operative infections.',
    parameter: 'Includes : 17 Parameters',
    price: 130,
    chennaiPrice: 530,
    banglorePrice: 450,
    andhraPradeshPrice: 130,
    discountAmount: 0,
    type: 'test',
    relatedToOrgan: 'bones&joints',
    testDetailsPageLink: '/crp-latex',
    popular: false,
