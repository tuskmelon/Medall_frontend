...
const AlbuminProteinUrine = {
    thumbnail: HoldingTestTube,
    testName: 'Albumin/Protein - Urine',
    rating: 4.1,
    alternateTestName: '',
    corpId: "1045",
    description: 'Screening test to find the presence of protein in the urine.',
    parameter: 'Includes : 17 Parameters',
    price: 50,
    chennaiPrice: 100,
    banglorePrice: 70,
    andhraPradeshPrice: "Not Available",
    discountAmount: 0,
    relatedToOrgan: 'liver',
    testDetailsPageLink: '/albuminproteinurine',
    popular: false,
    type: 'test',
...
export default AlbuminProteinUrine