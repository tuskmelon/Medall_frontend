...
export const CBCTest = {
    thumbnail: HoldingTestTube,
    testName: 'Complete Blood Count (CBC) ',
    rating: 4.1,
    corpId: "1211",
    alternateTestName: 'Blood Cell Count',
    description: 'A Complete Blood Count (CBC) is a blood test that is used to assess your general health and identify several illnesses, such as leukemia, anemia, clotting disorders and many other medical conditions.',
    ...
    discountAmount: 0,
    type: 'test',
    relatedToOrgan: 'blood',
    testDetailsPageLink: '/cbc-test',
    popular: true,
    ...
    propertiesTitle: 'What CBC test measures ?',
    properties: [
        {
        ...
        {
            text: 'The concentration of haemoglobin and the haematocrit'
        },
        {
