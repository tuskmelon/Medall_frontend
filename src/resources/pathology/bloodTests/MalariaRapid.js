...
const MalariaRapid = {
    ...
    testName: 'Rapid malaria test/Malarial antigen ',
    rating: 4.1,
    corpId: "1529",
    alternateTestName: '',
    description: 'It confirms the presence/Absence of malarial parasite.',
    ...
    testDetailsPageLink: '/malaria-rapid',
    popular: false,
