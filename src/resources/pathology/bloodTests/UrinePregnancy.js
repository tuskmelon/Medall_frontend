...
const UrinePregnancy = {
    thumbnail: HoldingTestTube,
    testName: 'Pregnancy test via Urine Sample/UG',
    rating: 4.1,
    corpId: "1686",
    alternateTestName: '',
    description: 'It helps in confirming  pregnancy.',
    ...
    testDetailsPageLink: '/urine-pregnancy',
    popular: false,
