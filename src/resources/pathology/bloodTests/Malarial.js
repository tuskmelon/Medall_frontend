...
const MalarialTest = {
    ...
    testName: 'Smear for Malarial Parasite (MP)',
    rating: 4.1,
    corpId: "1561",
    alternateTestName: '',
    description: "It helps in the diagnosis of malaria (an infection caused by plasmodium parasites).",
    ...
    testDetailsPageLink: '/malarial-test',
    popular: false,
