...
export const CoagulationPackage = {
    thumbnail: HoldingTestTube,
    testName: 'Coagulation Package',
    rating: 4.1,
    corpId: "1999",
    alternateTestName: '',
    description: "It measures blood's ability to clot and how long it takes to clot. This will help doctor to assess your risk of excessive bleeding or developing clots in your blood vessels.",
    parameter: 'Includes : 17 Parameters',
    price: 350,
    chennaiPrice: 500,
    banglorePrice: 600,
    andhraPradeshPrice: 700,
    discountAmount: 0,
    type: 'test',
    relatedToOrgan: 'blood',
    testDetailsPageLink: '/coagulation-package',
    popular: false,
...
export default CoagulationPackage