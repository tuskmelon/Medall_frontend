...
export const AntiCCP = {
    thumbnail: HoldingTestTube,
    testName: 'Anti Cyclic Citrullinated Peptide (Anti CCP) ',
    rating: 4.1,
    alternateTestName: '',
    corpId: "1074",
    description: 'It helps diagnose rheumatoid arthritis.',
    parameter: 'Includes : 17 Parameters',
    price: 1200,
    chennaiPrice: 1350,
    banglorePrice: 2600,
    andhraPradeshPrice: 1200,
    discountAmount: 0,
    type: 'test',
    relatedToOrgan: 'bones&joints joints immune system',
    testDetailsPageLink: '/anti-cpp',
    popular: false,
