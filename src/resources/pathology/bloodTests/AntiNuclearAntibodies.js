...
export const AntiNuclearAntibodies = {
    thumbnail: HoldingTestTube,
    testName: 'Anti Nuclear Antibodies (ANA) - Immunofluorescence',
    rating: 4.1,
    corpId: "4297",
    alternateTestName: '',
    description: 'It is useful in the diagnosis of  autoimmune diseases like SLE, mixed connective tissue disease, rheumatoid arthritis.',
    parameter: 'Includes : 17 Parameters',
    price: 1000,
    chennaiPrice: 600,
    banglorePrice: 1500,
    andhraPradeshPrice: 1000,
    discountAmount: 0,
    type: 'test',
    relatedToOrgan: 'whole body immune system',
    testDetailsPageLink: '/ana',
    popular: false,
...
export default AntiNuclearAntibodies
