...
const UrineMicroalbumin = {
    thumbnail: HoldingTestTube,
    testName: 'Urine Microalbumin - Spot Sample',
    rating: 4.1,
    corpId: "1681",
    alternateTestName: '',
    description: 'It is used to evaluate diabetic patients to  assess the potential of early onset of nephropathy before onset of proteinuria.',
    parameter: 'Includes : 17 Parameters',
    price: 400,
    chennaiPrice: 550,
    banglorePrice: 580,
    andhraPradeshPrice: 350,
    discountAmount: 0,
    type: 'test',
    relatedToOrgan: 'kidney',
    testDetailsPageLink: '/urine-microalbumin',
    popular: false,
...
export default UrineMicroalbumin