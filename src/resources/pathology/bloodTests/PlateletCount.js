...
const PlateletCountTest = {
    thumbnail: HoldingTestTube,
    testName: 'Platelet Count / Plt Count',
    rating: 4.1,
    corpId: "1497",
    alternateTestName: '',
    description: "It measures the number of platelets which helps to monitor bleeding disorders, bone marrow disease or anyother underlying conditions.",
    parameter: 'Includes : 17 Parameters',
    price: 200,
    chennaiPrice: 220,
    banglorePrice: 170,
    andhraPradeshPrice: 80,
    discountAmount: 0,
    type: 'test',
    relatedToOrgan: 'blood',
    testDetailsPageLink: '/platelet-count-test',
    popular: false,
...
export default PlateletCountTest