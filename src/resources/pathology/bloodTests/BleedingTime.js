...
const BleedingTimeTest = {
    thumbnail: HoldingTestTube,
    testName: 'Bleeding Time & Clotting Time',
    rating: 4.1,
    alternateTestName: '',
    corpId: "1137",
    description: 'Screening test for presurgical cases & bleeding disorders.',
    ...
    type: 'test',
    relatedToOrgan: '',
    testDetailsPageLink: '/bleeding-time-test',
    popular: false,
...
export default BleedingTimeTest