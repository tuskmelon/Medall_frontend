...
const RheumatoidArthritis = {
    ...
    testName: 'Rheumatoid Arthritis / RA Factor - Quantitative ',
    rating: 4.1,
    corpId: "1538",
    alternateTestName: '',
    description: 'It is useful in the  diagnosis of  rheumatoid arthritis.',
    ...
    testDetailsPageLink: '/rheumatoid-arthritis',
    popular: false,
