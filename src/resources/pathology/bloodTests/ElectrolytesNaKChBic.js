...
const ElectrolytesNaKChBic = {
    thumbnail: HoldingTestTube,
    testName: 'Electrolytes (NA/K/CL/BIC)',
    rating: 4.1,
    corpId: "1265",
    alternateTestName: '',
    description: 'To diagnose disorders associated with acid-base imbalance like diarrhea, renal failure .',
    ...
    testDetailsPageLink: '/electrolytes-na-k-ch-bic',
    popular: false,
...
export default ElectrolytesNaKChBic