...
const HaemogramTest = {
    ...
    alternateTestName: '',
    corpId: "1213",
    description: "It is useful in the diagnosis of  anaemia, infections, leukemias, clotting disorders, thrombocytopenia & presence of haemoparasites.",
    ...
    testDetailsPageLink: '/haemogram-test',
    popular: false,
