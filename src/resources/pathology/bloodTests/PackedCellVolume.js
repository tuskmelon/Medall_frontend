...
const PackedCellVolumeTest = {
    thumbnail: HoldingTestTube,
    testName: 'Packed Cell Volume/ PCV /HCT',
    rating: 4.1,
    corpId: "1481",
    alternateTestName: '',
    description: "It helps diagnose polycythaemia, dehydration and anemia.",
    ...
    testDetailsPageLink: '/packed-cell-volume-test',
    popular: false,
...
export default PackedCellVolumeTest