...
export const BetaHCG = {
    ...
    testName: 'Beta Human Chorionic Gonadotrophin - Beta HCG',
    rating: 4.1,
    alternateTestName: '',
    corpId: "1127",
    description: 'To check the progress of pregnancy and evaluate tumors of ovary and testis.',
    parameter: 'Includes : 17 Parameters',
    price: 1200,
    chennaiPrice: 660,
    banglorePrice: 980,
    andhraPradeshPrice: 640,
    discountAmount: 0,
    type: 'test',
    relatedToOrgan: 'hormones',
    testDetailsPageLink: '/beta-hcg',
    popular: false,
