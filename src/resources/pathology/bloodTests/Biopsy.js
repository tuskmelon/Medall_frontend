...
export const Biopsy = {
  ...
  testName: 'Biopsy (Small Specimen) - Microwave Technique',
  rating: 4.1,
  corpId: '4310',
  alternateTestName: '',
  description:
    'It helps in diagnosing  various diseases/Tumors affecting different parts of the body.',
  ...
  discountAmount: 0,
  type: 'test',
  relatedToOrgan: 'whole body',
  testDetailsPageLink: '/biopsy',
  popular: false,
  ...
  faqs: [
    ...
    },
    {
      ...
      description:
        "You usually won't need to prepare, but as it involves magnets you will need to remove anything that contains metal, including jewellery and hairpins.",
      descriptionSecond:
        'Before the scan, you may be injected with a dye called contrast (only contrast angiogram studies), through a cannula which is placed into a vein in the arm. This allows the MRI scanner to see your vessels in detail.',
      descriptionThird: ''
    },
    {
      ...
      description:
        "YYou'll need to keep still during the scan, so that the images come out clear. You'll be asked to lie on a bed that’s slowly moved head first into an MRI scanner. The scanner will make loud tapping sounds. You’ll be given earplugs or headphones so you can listen to music to distract you from the noise.",
      descriptionSecond:
        'The scan may last between 30 and 90 minutes, depending on how many images of the vessels are needed.',
      descriptionThird: ''
    },
    {
      title: 'Understanding ',
