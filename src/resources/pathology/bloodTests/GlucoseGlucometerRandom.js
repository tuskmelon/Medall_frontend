...
const GlucoseGlucometerRandom = {
    thumbnail: HoldingTestTube,
    testName: 'Glucose Glucometer - Random',
    rating: 4.1,
    corpId: "1335",
    alternateTestName: '',
    description: 'Screening test for diabetes',
    price: 60,
    chennaiPrice: 60,
    banglorePrice: 60,
    ...
    testDetailsPageLink: '/glucose-glucometer-random',
    popular: false,
...
export default GlucoseGlucometerRandom
