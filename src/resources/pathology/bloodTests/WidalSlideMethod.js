...
const WidalSlideMethod = {
    thumbnail: HoldingTestTube,
    testName: 'Widal (Slide Method )',
    rating: 4.1,
    corpId: "1737",
    alternateTestName: '',
    description: 'It is useful in diagnosing  typhoid and parathyroid fevers.',
    parameter: 'Includes : 17 Parameters',
    price: 150,
    chennaiPrice: 500,
    banglorePrice: 330,
    andhraPradeshPrice: 70,
    discountAmount: 0,
    type: 'test',
    relatedToOrgan: 'git systemic',
    testDetailsPageLink: '/widal-slide-method',
    popular: false,
...
export default WidalSlideMethod
