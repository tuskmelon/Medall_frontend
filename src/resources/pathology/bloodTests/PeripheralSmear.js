...
const PeripheralSmearTest = {
    thumbnail: HoldingTestTube,
    testName: 'Peripheral Smear Study /PS/PBS',
    rating: 4.1,
    corpId: "1489",
    alternateTestName: '',
    description: "It is useful in diagnosing hematological disorders/Diseases,finding the cause of abnormal calcium levels & status of chronic kidney disease(CKD).",
    ...
    testDetailsPageLink: '/peripheral-smear-test',
    popular: false,
...
export default PeripheralSmearTest