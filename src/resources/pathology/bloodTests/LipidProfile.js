...
const LipidTest = {
    ...
    corpId: "1445",
    alternateTestName: '',
    description: 'A lipid profile is a panel of blood tests used to find abnormalities in lipids, such as cholesterol and triglycerides. The results of this test can determine approximate risks for cardiovascular disease.',
    parameter: 'Includes : 17 Parameters',
    price: 550,
    chennaiPrice: 600,
    banglorePrice: 660,
    andhraPradeshPrice: 450,
    discountAmount: 0,
    type: 'test',
    relatedToOrgan: 'heart',
    testDetailsPageLink: '/lipid-test',
    popular: true,
    ...
    propertiesTitle: 'What does Lipid Profile measures ?',
    properties: [
        {
