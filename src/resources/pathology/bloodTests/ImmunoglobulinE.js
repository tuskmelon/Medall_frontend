...
const ImmunoglobulinE = {
    thumbnail: HoldingTestTube,
    testName: 'Immunoglobulin E - Total',
    rating: 4.1,
    corpId: "1394",
    alternateTestName: '',
    description: 'It helps  detect allergic disorders.',
    ...
    testDetailsPageLink: '/immunoglobulin-e',
    popular: false,
...
export default ImmunoglobulinE
