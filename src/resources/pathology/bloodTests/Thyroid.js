...
const ThyriodTest = {
    ...
    corpId: "1637",
    alternateTestName: '',
    description: 'Thyroid Function Test (TFT) is a group of blood tests used to check the function of Thyroid.',
    ...
    testDetailsPageLink: '/thyroid-test',
    popular: true,
    ...
    propertiesTitle: 'What does Thyroid Profile measures ? ',
    properties: [
        // {
        //     text: 'Test includes Bilirubin'
        // },
        {
