...
const UrineBile = {
    ...
    testName: 'Urine for Bile Salt & Bile Pigment',
    rating: 4.1,
    corpId: "1672",
    alternateTestName: '',
    description: 'It helps in diagnosing jaundice and evaluation of liver diseases.',
    ...
    testDetailsPageLink: '/urine-bile',
    popular: false,
