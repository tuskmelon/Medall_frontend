...
export const CholesterolTotal = {
    thumbnail: HoldingTestTube,
    testName: 'Cholesterol Total',
    rating: 4.1,
    alternateTestName: '',
    corpId: "1198",
    description: 'It helps measure total amount of fatty substances in the blood &  assess the risk of cardiovascular disease.',
    ...
    testDetailsPageLink: '/cholesterol-total',
    popular: false,
...
export default CholesterolTotal