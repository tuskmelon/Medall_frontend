...
export const AntiStreptolysinTest = {
    thumbnail: HoldingTestTube,
    testName: 'Anti Streptolysin O / ASO titre - Quantitative',
    rating: 4.1,
    alternateTestName: '',
    corpId: "1095",
    description: 'It is useful to detect exposure to streptococcal infection.',
    parameter: 'Includes : 17 Parameters',
    price: 450,
    chennaiPrice: 500,
    banglorePrice: 500,
    andhraPradeshPrice: 650,
    discountAmount: 0,
    type: 'test',
    relatedToOrgan: 'blood',
    testDetailsPageLink: '/anti-streptolysin-test',
    popular: false,
...
export default AntiStreptolysinTest