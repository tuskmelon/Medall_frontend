...
const MalariaQBC = {
    ...
    testName: 'Malaria Test/ MP - QBC Method',
    rating: 4.1,
    corpId: "1450",
    alternateTestName: '',
    description: 'It helps diagnose malarial infection.',
    ...
    discountAmount: 0,
    type: 'test',
    relatedToOrgan: 'blood systemic',
    testDetailsPageLink: '/malaria-qbc',
    popular: false,
