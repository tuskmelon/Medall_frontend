...
const TrimesterDown = {
    ...
    testName: '1st Trimester Down Syndrome Screening/Double Marker ',
    rating: 4.1,
    alternateTestName: '',
    cropId : "1002",
    description: 'It evaluates the risk of carrying a baby with down syndrome.',
    parameter: 'Includes : 17 Parameters',
    price: 2200,
    chennaiPrice: 2200,
    banglorePrice: 2900,
    andhraPradeshPrice: 2000,
    discountAmount: 0,
    type: 'test',
    relatedToOrgan: 'female reproductive',
    testDetailsPageLink: '/trimester-down',
    popular: false,
    ...
    iconWithText: [
        ...
        {
            icon: Toilet,
            text: 'Recommended for only for female'
        },
        {
            icon: DeliveryMan,
