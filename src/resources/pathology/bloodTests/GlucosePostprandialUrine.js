...
const GlucosePostprandialUrine = {
    thumbnail: HoldingTestTube,
    testName: 'Glucose - Postprandial with Urine glucose',
    rating: 4.1,
    corpId: "1316",
    alternateTestName: '',
    description: 'It helps diagnose & monitor  diabetes & pre-diabetes.',
    parameter: 'Includes : 17 Parameters',
    price: 70,
    chennaiPrice: 110,
    banglorePrice: 100,
    andhraPradeshPrice: 40,
    discountAmount: 0,
    type: 'test',
    relatedToOrgan: 'hormones',
    testDetailsPageLink: '/glucose-postprandial-urine',
    popular: false,

    iconWithText: [
        {
            icon: Fasting,
            text: '2hrs after last meal'
        },
        {
            icon: Toilet,
...
export default GlucosePostprandialUrine
