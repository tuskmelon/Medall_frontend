...
const BloodCountWithESRTest = {
    thumbnail: HoldingTestTube,
    testName: 'Complete Blood Count with ESR ',
    rating: 4.1,
    alternateTestName: '',
    corpId: "1214",
    description: "It is useful in the diagnosis of anaemia, infections, leukemias, clotting disorders & many other medical conditions & ESR helps to detect inflammationin the body.",
    ...
    testDetailsPageLink: '/blood-count-with-esr-test',
    popular: false,
...
export default BloodCountWithESRTest