...
const UrineAerobic = {
    ...
    testName: 'Urine for Culture & Sensitivity- Aerobic',
    rating: 4.1,
    corpId: "1683",
    alternateTestName: '',
    description: 'It helps to detect aerobic bacterial infection',
    ...
    testDetailsPageLink: '/urine-aerobic',
    type: 'test',
    popular: false,
