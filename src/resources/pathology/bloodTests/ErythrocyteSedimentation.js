...
const ErythrocyteSedimentationTest = {
    thumbnail: HoldingTestTube,
    testName: 'Erythrocyte Sedimentation Rate / ESR',
    rating: 4.1,
    corpId: "1269",
    alternateTestName: '',
    description: "It helps diagnose inflammations , infections and monitor response to treatment of certain diseases.",
    ...
    testDetailsPageLink: '/erythrocyte-sedimentation-test',
    popular: false,
...
export default ErythrocyteSedimentationTest