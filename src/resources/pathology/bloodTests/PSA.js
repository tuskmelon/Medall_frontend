...
const PSA = {
    ...
    testName: 'Total Prostate Specific Antigen - PSA',
    rating: 4.1,
    corpId: "1638",
    alternateTestName: '',
    description: 'Screening test for prostate cancer and helps to monitor effectiveness of treatment for prostate cancer.',
