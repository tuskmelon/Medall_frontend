...
const VitaminB12 = {
    ...
    corpId: "1721",
    alternateTestName: '',
    description: 'This test measures the amount of vitamin B12 in blood which is important for brain health & proper nerve functioning.',
    parameter: 'Includes : 17 Parameters',
    price: 1000,
    chennaiPrice: 1100,
    banglorePrice: 1400,
    andhraPradeshPrice: 850,
    discountAmount: 0,
    type: 'test',
    relatedToOrgan: 'blood',
    testDetailsPageLink: '/vitamin-b12',
    popular: true,
