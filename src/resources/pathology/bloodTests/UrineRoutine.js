...
const UrineRotuine = {
    ...
    corpId: "1715",
    alternateTestName: '',
    description: 'It helps identify renal damage,  urinary tract infections, diabetes, kidney stones , hypertension and drug toxicity .',
    parameter: 'Includes : 17 Parameters',
    price: 150,
    chennaiPrice: 170,
    banglorePrice: 170,
    andhraPradeshPrice: 50,
    discountAmount: 0,
    type: 'test',
    relatedToOrgan: 'kidney',
    testDetailsPageLink: '/urine-routine',
    popular: false,
    ...
    iconWithText: [
        ...
        {
            icon: DeliveryMan,
            text: 'Caring phlebotomist & home dample collection'
        },
        {
            icon: Support,
            text: '24/7 Support'
