...
const GlucosePostprandial = {
    thumbnail: HoldingTestTube,
    testName: 'Glucose Postprandial',
    rating: 4.1,
    corpId: "1314",
    alternateTestName: '',
    description: 'It helps diagnose  &  to monitor  diabetes & pre-diabetes.',
    ...
    testDetailsPageLink: '/glucose-postprandial',
    popular: false,
...
export default GlucosePostprandial
