...
const StoolAnalysisRoutine = {
    thumbnail: HoldingTestTube,
    testName: 'Stool Analysis - Routine ',
    rating: 4.1,
    corpId: "1609",
    alternateTestName: '',
    description: 'It is useful to detect the conditions affecting digestive tract due to any functional abnormalities,parasitic & bacterial infections.',
    ...
    discountAmount: 0,
    type: 'test',
    relatedToOrgan: 'digestive system',
    testDetailsPageLink: '/stool-analysis-routine',
    popular: false,
...
export default StoolAnalysisRoutine
