...
const WBCCount = {
    ...
    testName: 'Total WBC Count/TC',
    rating: 4.1,
    corpId: "1648",
    alternateTestName: '',
    description: 'It helps detect & monitor infections, inflammatory conditions , blood cancer.',
