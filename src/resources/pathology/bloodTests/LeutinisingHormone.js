...
const LeutinisingHormone = {
    thumbnail: HoldingTestTube,
    testName: 'Leutinising Hormone (LH)',
    rating: 4.1,
    corpId: "1438",
    alternateTestName: '',
    description: 'It helps evaluate menstural irregularities & infertility , predict ovulation  and diagnose pituitary disorders.',
    ...
    testDetailsPageLink: '/leutinising-hormone',
    popular: false,
...
export default LeutinisingHormone
