...
const RenalFunction = {
    ...
    testName: 'Renal Function RFT',
    rating: 4.1,
    corpId: "1540",
    alternateTestName: '',
    description: 'It is useful to  evaluate renal function, help diagnose kidney-related disorders & screen those who may be at risk of developing kidney disease.',
    parameter: 'Includes : 17 Parameters',
    price: 750,
    chennaiPrice: 950,
    banglorePrice: 950,
    andhraPradeshPrice: 500,
    discountAmount: 0,
    type: 'test',
    relatedToOrgan: 'kidney',
    testDetailsPageLink: '/renal-function',
    popular: true,
    ...
    propertiesTitle: 'What does Renal Function measures?',
    properties: [
        {
            text: 'Urea'
        },
