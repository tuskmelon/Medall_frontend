...
const ProteinCreatRatio = {
    thumbnail: HoldingTestTube,
    testName: 'Protein / Creatinine Ratio - Urine - Spot Sample',
    rating: 4.1,
    corpId: "1516",
    alternateTestName: '',
    description: 'It helps measure and monitor protein and creatinine excretion in adults with Chronic Kidney Disease (CKD).',
    ...
    testDetailsPageLink: '/creatinine-heart',
    popular: false,
...
export default ProteinCreatRatio