// import other images 
import Machine from '../../../assets/images/mri/knee-mri-machine.jpg'
...
export const KneeMRI = {
    title: 'Knee MRI',
    thumbnail: 'https://medallwebsite.s3.ap-south-1.amazonaws.com/radiology/MRI-Image/Knee-MRI-img.jpg',
    type: 'MRI',
    // highlightType: 'MRI',
    price: 'NA',
    chennaiPrice: 7500,
    ...
    imageWithInfo: {
        ...
        highlightedTitle: 'Knee MRI',
        image: Machine,
        description: [
            {
                text: "An MRI of the knee helps find problems such as damage to the ligaments and cartilage around the knee. The MRI also can look for the cause of unexplained knee pain, or infections in or around the knee."
            },
        ]
    },
    faqs: [
        ...
        },
        {
            ...
            description: [
                {
                    text: "You usually won't need to prepare for a knee MRI scan, but as it involves magnets you will need to remove anything that contains metal, including jewellery and hairpins."
                },
            ]
        },
        {
            ...
            description: [
                ...
                {
                    text: "The scan may last between 15 to 30 minutes, depending on how many images of the knee are needed."
                }
            ]
        },
        {
            title: 'Understanding ',
            highlightedTitle: 'your Knee MRI results',
            description: [
                {
