...
export const ShoulderMRI = {
    title: 'Shoulder MRI',
    thumbnail: 'https://medallwebsite.s3.ap-south-1.amazonaws.com/radiology/MRI-Image/Shoulder-MRI-Img.jpg',
    type: 'MRI',
    // highlightType: 'MRI',
    price: 'NA',
    chennaiPrice: 7500,
    ...
    faqs: [
        ...
        },
        {
            ...
            description: [
                {
                    text: "You usually won't need to prepare for a shoulder MRI scan, but as it involves magnets you will need to remove anything that contains metal, including jewellery and hairpins."
                },
            ]
        },
        {
            ...
            description: [
                ...
                {
                    text: "The scan may last between 20 to 45 minutes, depending on how many images of the shoulder are needed."
                }
            ]
        },
        {
            title: 'Understanding ',
            highlightedTitle: 'your Shoulder MRI results',
            description: [
                {
