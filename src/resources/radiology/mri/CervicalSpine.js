// import other images 
import Machine from '../../../assets/images/mri/spine-mri-machine.jpg'
...
export const SpineMRI = {
    title: 'Cervial Spine MRI',
    thumbnail: 'https://medallwebsite.s3.ap-south-1.amazonaws.com/radiology/MRI-Image/Cervical-Spine-MRI-img.jpg',
    type: 'MRI',
    // highlightType: 'MRI',
    price: 'NA',
    chennaiPrice: 7500,
    ...
    imageWithInfo: {
        ...
        highlightedTitle: 'Cervical Spine MRI',
        image: Machine,
        description: [
            {
                text: "Your doctor may recommend an MRI to better diagnose or treat problems with your spine like injury-related pain, severe neck ache, radiculopathy, infection, tumor, demyelination, birth defects etc."
            },
            // {
    ...
    faqs: [
        ...
        },
        {
            ...
            description: [
                {
                    text: "You usually won't need to prepare for a cervical spine MRI scan, but as it involves magnets you will need to remove anything that contains metal, including jewellery and hairpins.	"
                },
            ]
        },
        {
            ...
            description: [
                ...
                {
                    text: "The scan may last between 15 and 45 minutes, depending on how many images of the spine are needed."
                }
            ]
        },
        {
            title: 'Understanding ',
            highlightedTitle: 'your Cervical Spine MRI results	',
            description: [
                {
